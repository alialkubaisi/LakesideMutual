...
COPY src /home/app/customer-management-frontend/src
COPY pom.xml /home/app/customer-management-frontend
RUN mvn -f /home/app/customer-management-frontend/pom.xml clean package
...
COPY --from=build /home/app/customer-management-frontend/target/customer-management-frontend-0.0.1-SNAPSHOT.jar /usr/local/lib/customer-management-frontend.jar
EXPOSE 8082
ENTRYPOINT ["java", "-jar", "/usr/local/lib/customer-management-frontend.jar"]